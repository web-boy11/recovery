...
export const TRANSLATIONS: Record<Language, TranslationSchema> = {
  ...
  en: {
    ...
    header: {
      ...
      unit: "Cybercrime & Financial Fraud Recovery — Mc Collins Unit (US · EU · UK)",
    ...
    about: {
      ...
      title: "FBI Cybercrime & Transatlantic Financial Fraud Recovery — Mc Collins Unit",
      p1: "The Fraud & Funds Recovery Division (FFRD) is a specialized unit operating under the auspices of the U.S. Department of Justice and the Transatlantic Cybercrime Working Group. Chaired by Special Agent-in-Charge Mc Collins, a 22-year veteran of transnational financial investigation, the unit coordinates directly with Europol (European Cybercrime Centre - EC3, The Hague) and Interpol to assist victims across North America and Europe.",
      ...
      leaderName: "Special Agent Mc Collins",
      leaderTitle: "Unit Chief, Badge #J.4267-MC",
      ...
      verifyStep1: "Call the FBI HQ switchboard at +1 (202) 324-3000 or Europol EC3 liaison",
      verifyStep2: "Request the Transatlantic Fraud Recovery Unit — Mc Collins",
    ...
    fraudTypes: {
      ...
      subtitle: "The Mc Collins Unit accepts cases originating across the United States, United Kingdom, and European Union involving major monetary losses.",
      types: {
        crypto: {
    ...
    report: {
      ...
      desc: "Submit this confidential intake form. A sworn investigator from the Mc Collins Unit will review your evidence within 24 business hours. Submissions are encrypted (TLS 1.3) and protected under US and European privacy standards.",
      hotlineLabel: "24/7 International Task Force Hotline",
      ...
      successDesc: "Your case reference number is {caseRef}. A sworn agent from the Mc Collins Transatlantic Unit will review your file and contact you within 24 business hours.",
    },
    faq: {
  ...
  de: {
    ...
    header: {
      ...
      agency: "Federal Bureau of Investigation",
      unit: "Cyberkriminalität & Rückholung von Betrugsgeldern — Einheit Mc Collins (US · EU · UK)",
    ...
    about: {
      ...
      leaderName: "Special Agent Mc Collins",
      leaderTitle: "Leiter der Einheit, Dienstmarke #J.4267-MC",
      ...
      verifyStep1: "Rufen Sie die offizielle FBI-Zentrale (+1 202 324-3000) oder die Europol-Verbindungsstelle an",
      verifyStep2: "Fragen Sie nach der Einheit Mc Collins (Transatlantic Fraud Recovery)",
    ...
    report: {
      ...
      hotlineLabel: "24/7 Internationale Taskforce-Hotline",
      ...
      successDesc: "Ihr offizielles Aktenzeichen lautet: {caseRef}. Ein Ermittler der Einheit Mc Collins wird Ihre Unterlagen sichten und sich innerhalb von 24 Geschäftsstunden bei Ihnen melden.",
    },
    faq: {
      ...
      a3: "JA. Im Rahmen der transatlantischen Cybercrime-Vereinbarung operiert die Einheit Mc Collins in direkter Kooperation mit Europol EC3, der britischen National Crime Agency (NCA) und Interpol. Bürger und Personen mit Wohnsitz in Deutschland, Österreich, der Schweiz, der gesamten Europäischen Union sowie dem Vereinigten Königreich haben vollen Anspruch auf Fallaufnahme, forensische Ermittlungen und Rückholungsunterstützung.",
    },
    footer: {
  ...
  fr: {
    ...
    header: {
      ...
      agency: "Federal Bureau of Investigation",
      unit: "Répression des Cybercrimes et Recouvrement des Fonds — Unité Mc Collins (US · UE · RU)",
    ...
    about: {
      ...
      title: "FBI Cybercriminalité & Recouvrement Financier Transatlantique — Unité Mc Collins",
      p1: "La Division de Recouvrement des Fraudes et Fonds (FFRD) est une unité spécialisée opérant sous l'égide du Département de la Justice des États-Unis et du Groupe Transatlantique de Cybercriminalité. Dirigée par l'agent spécial Mc Collins, fort de 22 ans d'expérience dans les enquêtes financières internationales, elle collabore directement avec Europol (Centre européen de lutte contre la cybercriminalité - EC3, La Haye) et Interpol.",
      ...
      leaderName: "Agent Spécial Mc Collins",
      leaderTitle: "Chef d'Unité, Matricule #J.4267-MC",
      ...
      verifyStep1: "Contactez le standard officiel du FBI (+1 202 324-3000) ou la liaison Europol",
      verifyStep2: "Demandez l'Unité de Recouvrement Transatlantique — Mc Collins",
    ...
    fraudTypes: {
      ...
      subtitle: "L'Unité Mc Collins instruit les dossiers signalés en France, en Belgique, en Suisse et dans l'ensemble de l'Union européenne.",
      types: {
        crypto: {
    ...
    report: {
      ...
      desc: "Remplissez ce formulaire sécurisé. Un enquêteur assermenté de l'Unité Mc Collins étudiera vos pièces justificatives sous 24 heures ouvrées. Vos données sont chiffrées en TLS 1.3.",
      hotlineLabel: "Permanence Téléphonique Internationale 24/7",
      ...
      successDesc: "Votre référence officielle de dossier est : {caseRef}. Un agent spécial de l'Unité Transatlantique Mc Collins examinera vos justificatifs et prendra contact sous 24 heures ouvrées.",
    },
    faq: {
      ...
      a3: "OUI. Dans le cadre de la directive d'action transatlantique contre la cybercriminalité, l'Unité Mc Collins agit en partenariat opérationnel direct avec Europol EC3, la National Crime Agency (NCA) britannique et Interpol. Les victimes résidant en France, en Belgique, en Suisse, dans les 27 pays de l'Union européenne et au Royaume-Uni bénéficient de la pleine compétence d'instruction, de traçage et d'assistance au recouvrement.",
    },
    footer: {
  ...
  es: {
    ...
    header: {
      ...
      agency: "Federal Bureau of Investigation",
      unit: "División de Recuperación de Fraudes Financieros — Unidad Mc Collins (EE. UU. · UE · Reino Unido)",
    ...
    about: {
      ...
      leaderName: "Agente Especial Mc Collins",
      leaderTitle: "Jefe de Unidad, Credencial #J.4267-MC",
      ...
      verifyStep1: "Llame a la central del FBI (+1 202 324-3000) o a la oficina de enlace de Europol",
      verifyStep2: "Solicite comunicación con la Unidad Mc Collins de Recuperación Transatlántica",
    ...
    fraudTypes: {
      ...
      subtitle: "La Unidad Mc Collins admite denuncias procedentes de España, la Unión Europea, el Reino Unido y los Estados Unidos.",
      types: {
        crypto: {
    ...
    report: {
      ...
      desc: "Complete este formulario protegido. Un funcionario asignado de la Unidad Mc Collins examinará su caso en menos de 24 horas hábiles. Todos los datos están protegidos con cifrado TLS 1.3.",
      hotlineLabel: "Línea de Asistencia Internacional 24 Horas",
      ...
      successDesc: "Su número oficial de caso es: {caseRef}. Un agente asignado de la Unidad Transatlántica Mc Collins examinará su documentación y le contactará en un plazo de 24 horas hábiles.",
    },
    faq: {
  ...
  it: {
    ...
    header: {
      ...
      agency: "Federal Bureau of Investigation",
      unit: "Recupero Frodi Finanziarie e Cibernetiche — Unità Mc Collins (USA · UE · Regno Unito)",
    ...
    about: {
      ...
      leaderName: "Agente Speciale Mc Collins",
      leaderTitle: "Comandante dell'Unità, Distintivo #J.4267-MC",
      ...
      verifyStep1: "Chiamate il centralino ufficiale dell'FBI (+1 202 324-3000) o la sede Europol",
      verifyStep2: "Chiedete del reparto Transatlantic Fraud Recovery — Unità Mc Collins",
    ...
    fraudTypes: {
      ...
      subtitle: "L'Unità Mc Collins prende in carico pratiche provenienti da Italia, Unione Europea, Regno Unito e Stati Uniti.",
      types: {
        crypto: {
    ...
    report: {
      ...
      desc: "Compilate questo modulo ufficiale. Un funzionario dell'Unità Mc Collins esaminerà la documentazione entro 24 ore lavorative. I dati sono protetti da cifratura TLS 1.3.",
      hotlineLabel: "Centrale Telefonica Internazionale 24/7",
      ...
      successDesc: "Il vostro numero di protocollo è: {caseRef}. Un agente dell'Unità Transatlantica Mc Collins esaminerà la pratica e vi ricontatterà entro 24 ore lavorative.",
    },
    faq: {
      ...
      a3: "ASSOLUTAMENTE SÌ. In conformità con le direttive operative transatlantiche contro la criminalità finanziaria, l'Unità Mc Collins opera in cooperazione congiunta con Europol EC3, la National Crime Agency (NCA) britannica e Interpol. I cittadini e i residenti in Italia, nell'Unione Europea, nel Regno Unito e negli Stati Uniti godono di piena titolarità per la presa in carico, l'analisi forense e il recupero patrimoniale.",
    },
    footer: {
  ...
  nl: {
    ...
    header: {
      ...
      agency: "Federal Bureau of Investigation",
      unit: "Aanpak Cybercriminaliteit & Terugvordering van Fraudegelden — Eenheid Mc Collins (VS · EU · VK)",
    ...
    about: {
      ...
      title: "FBI Cybercrime & Trans-Atlantische Vermogensrecuperatie — Eenheid Mc Collins",
      p1: "De Afdeling Fraude en Vermogensrecuperatie (FFRD) is een gespecialiseerde eenheid onder auspiciën van het Amerikaanse Ministerie van Justitie en de Trans-Atlantische Werkgroep Cybercrime. Onder leiding van Hoofdagent Mc Collins werkt de eenheid rechtstreeks samen met Europol (Europees Cybercrime Centrum - EC3 te Den Haag) en Interpol.",
      ...
      leaderName: "Speciaal Agent Mc Collins",
      leaderTitle: "Hoofd van de Eenheid, Dienstnummer #J.4267-MC",
      ...
      verifyStep1: "Bel de officiële FBI-centrale (+1 202 324-3000) of het Europol-verbindingsbureau",
      verifyStep2: "Vraag naar de Eenheid Mc Collins (Transatlantic Fraud Recovery)",
    ...
    fraudTypes: {
      ...
      subtitle: "De Eenheid Mc Collins behandelt dossiers afkomstig uit Nederland, België, de Europese Unie, het VK en de VS.",
      types: {
        crypto: {
    ...
    report: {
      ...
      desc: "Vul dit beveiligde formulier in. Een beëdigd rechercheur van de Eenheid Mc Collins beoordeelt uw dossier binnen 24 werkuren. Gegevensoverdracht is beveiligd via TLS 1.3-versleuteling.",
      hotlineLabel: "24/7 Internationale Hulplijn",
      ...
      successDesc: "Uw officiële dossiernummer luidt: {caseRef}. Een rechercheur van de Trans-Atlantische Eenheid Mc Collins zal uw bewijsstukken beoordelen en binnen 24 werkuren contact met u opnemen.",
    },
    faq: {
      ...
      a3: "JA, ZEKER. Krachtens de trans-atlantische samenwerkingsrichtlijn opereert de Eenheid Mc Collins in nauw partnerschap met Europol EC3, de Britse National Crime Agency (NCA) en Interpol. Slachtoffers woonachtig in Nederland, België, alle lidstaten van de Europese Unie, het VK en de VS komen volledig in aanmerking voor intake, forensisch onderzoek en internationale vermogensrecuperatie.",
    },
    footer: {
